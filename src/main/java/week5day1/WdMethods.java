...
public interface WdMethods {
	...
	/**
	 * This method will populate the value in the given text field 
	 * @param ele   - The Webelement (text field) in which the data to be entered
	 * @param data  - The data to be sent to the webelement
	 * @author Babu - TestLeaf
	 * @throws ElementNotVisibleException		 * 
	 ...
	 * @param ele   - The Webelement (text/link/element) to be clear
	 * @author Babu - TestLeaf
	 */
	...
	/**
	 * This method will perform move mouse over actions
	 * @author Babu - TestLeaf
	 */
	public void moveMouseOver(WebElement ele);

	/**
	 * This method will perform move mouse over on click actions
	 * @author Babu - TestLeaf
	 */
	...
	/**
	 * This method will perform context click actions
	 * @author Babu - TestLeaf
	 */
	public void contextClick(WebElement ele);

	/**
	 * This method will drag and drop by the elements
	 * @author Babu - TestLeaf
	 */
	public void dragDropBy(WebElement ele,WebElement ele1);

	/**
	 * This method will drag and drop the elements
	 * @author Babu - TestLeaf
	 */
	...
	/**
	 * This method will print the content present in web table
	 * @author Prasanth - TestLeaf
	 */
