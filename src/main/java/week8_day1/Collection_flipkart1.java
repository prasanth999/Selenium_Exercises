...
public class Collection_flipkart1 {
	...
	public static void main(String[] args)
	{
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("_3auQ3N")));
		List<WebElement> name = driver.findElementsByClassName("_3auQ3N");
